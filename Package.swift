...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.10.155/foxKit-4.0.10.155.zip",
            checksum: "52db001acaa930cf4d55f53b68894e55a8651c17ee70ac5b4d6e71c336ad2233"
        ),
    ]
)
