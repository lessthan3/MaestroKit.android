...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.23.255/foxKit-4.0.23.255.zip",
            checksum: "961caa6f99880f68c31197281398aedd75782f80ebc61a5f4aa95b43ce592f89"
        ),
    ]
)
