...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "paramountKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/paramountKit-4.0.29.301/paramountKit-4.0.29.301.zip",
            checksum: "c621f84d7ae6b74ea895deff8dbe85df285d869edda9902daa0f0b677de73e1a"
        ),
    ]
)
