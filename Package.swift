...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.12.176/foxKit-4.0.12.176.zip",
            checksum: "e864d37f20f0062d12d7968f50ac7d3acc2d5d2acfe61797504dba15f98ba30e"
        ),
    ]
)
