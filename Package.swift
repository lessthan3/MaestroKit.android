...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.11.165/foxKit-4.0.11.165.zip",
            checksum: "a7db9f9403d6b79ca49e6137514acc077dcf40dd12a7d84abb6a0606820aa960"
        ),
    ]
)
