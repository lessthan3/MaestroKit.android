...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.14.196/foxKit-4.0.14.196.zip",
            checksum: "ed34e45f532fc981f366486c92b0b8fcc5c9df60d140600d0813a922fff56a56"
        ),
    ]
)
