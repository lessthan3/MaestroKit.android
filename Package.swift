...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.21.247/foxKit-4.0.21.247.zip",
            checksum: "723f25cb467f614a6c42831196e5c8195de56c115ba18cd00a79d6e77b52b7a7"
        ),
    ]
)
