...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.15.202/foxKit-4.0.15.202.zip",
            checksum: "cac9b84718294fbf11db3d6b7f533311852200d59a44c4999d8fe9e60868cce3"
        ),
    ]
)
