...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.7.131/foxKit-4.0.7.131.zip",
            checksum: "0a58c54d0d1ed3114fb4574fe66ee8fd3a9b58b5ff295275a30d2f08593fc8ed"
        ),
    ]
)
