...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.11.170/foxKit-4.0.11.170.zip",
            checksum: "a16ac2c0fb1b4cc573ec01399f59eabf43fda9c95fde261489091361e05c1e51"
        ),
    ]
)
