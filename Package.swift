...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.11.168/foxKit-4.0.11.168.zip",
            checksum: "04c0c6ee5d51284a20a12f0638488db6dd0f7c9b270bceb3dd68d509892c394f"
        ),
    ]
)
