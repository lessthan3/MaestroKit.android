...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.7.132/foxKit-4.0.7.132.zip",
            checksum: "7750ee44875cad6f66e6a14ad33f541dcfc6a80fa1687af5c9c652ef849dfdd5"
        ),
    ]
)
