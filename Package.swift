...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.20.243/foxKit-4.0.20.243.zip",
            checksum: "65f07cfaffa9e6e246e69aa4b524979daf94f5f7ef51a4e840d5b50a9510bd16"
        ),
    ]
)
