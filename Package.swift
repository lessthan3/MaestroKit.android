...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/4.0.0-SNAPSHOT.73/foxKit-4.0.0-SNAPSHOT.73.zip",
            checksum: "e4dae1783c6c540367bde064cdaba8cc57afc116578d8aafe503c5414432d229"
        ),
    ]
)
