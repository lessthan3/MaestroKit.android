...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.15.208/foxKit-4.0.15.208.zip",
            checksum: "1fec8b44e753ab9f5c9182d7ba9f3a29767fe24780dfbf38f59bd24d650a84d0"
        ),
    ]
)
