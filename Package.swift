...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.10.158/foxKit-4.0.10.158.zip",
            checksum: "1350eda37326e9b6c639dbd8479c369ab422e701c98ebcd61063d169e18b0d3a"
        ),
    ]
)
