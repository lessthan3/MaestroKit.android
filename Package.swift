...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/4.0.0-SNAPSHOT.92/foxKit-4.0.0-SNAPSHOT.92.zip",
            checksum: "a97efc8707b0ad33aa7794a7a09941d5a3efa14bedfd4bf15dd5dcace294a8f8"
        ),
    ]
)
