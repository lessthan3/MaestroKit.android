...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/4.0.0-SNAPSHOT.86/foxKit-4.0.0-SNAPSHOT.86.zip",
            checksum: "ebccfc09275e0da42eba8f112c6f3cd3a010b4d3819501536415bef74152814e"
        ),
    ]
)
