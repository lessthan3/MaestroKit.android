...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.12.173/foxKit-4.0.12.173.zip",
            checksum: "5416dcfcab366a2dd30113a4eac661f4ea5f74c64293a885a9b3734f6397dd25"
        ),
    ]
)
