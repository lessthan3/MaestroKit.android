...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.13.180/foxKit-4.0.13.180.zip",
            checksum: "a5ec21e1376bd2f5a894a3998a1307f99067da1c9bc935faaf39ee6046f3455f"
        ),
    ]
)
