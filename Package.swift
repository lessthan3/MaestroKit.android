...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.20.238/foxKit-4.0.20.238.zip",
            checksum: "656d9d729e8c7c380beaed3fc8803ccca3e28a763b2e1172808b9bd8fc9fa3ef"
        ),
    ]
)
