...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.18.222/foxKit-4.0.18.222.zip",
            checksum: "6c3210d432241d2ee75cf056ce48d6cc508ef06ff3c30a9818ef623125c273de"
        ),
    ]
)
