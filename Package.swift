...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.23.256/foxKit-4.0.23.256.zip",
            checksum: "2832966cf8cf856aefdfac059f84890b077d5e824cb3dbcbf830e839add9cde4"
        ),
    ]
)
