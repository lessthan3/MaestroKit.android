...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.8.140/foxKit-4.0.8.140.zip",
            checksum: "e33efcce1ccc5148c1294cfb197b946ec255cd1092a4c65bdf1d908b1bed4e1d"
        ),
    ]
)
