...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.7.133/foxKit-4.0.7.133.zip",
            checksum: "7a51cc2b0fcd64c203319420be961160352e1a738da7ef2b070fbfa6f46026be"
        ),
    ]
)
