...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.9.153/foxKit-4.0.9.153.zip",
            checksum: "64510faa7a81d50ebeb782532997eb707e8580d66c52092ae5c91bebdd7008c5"
        ),
    ]
)
