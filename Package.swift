...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.14.191/foxKit-4.0.14.191.zip",
            checksum: "16dc0b6941a24901d41d74b1cea0909b0bffa9e986a056bd764947d8925de2de"
        ),
    ]
)
