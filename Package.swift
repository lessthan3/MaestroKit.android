...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.13.181/foxKit-4.0.13.181.zip",
            checksum: "743c4d9bc0f59c0fb503aa351a204b9448b7049cf87545097d114e18fec14ab9"
        ),
    ]
)
