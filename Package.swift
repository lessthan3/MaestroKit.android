...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.16.216/foxKit-4.0.16.216.zip",
            checksum: "be1e5b224389b88fc22da4d0c2f2640a3101ec76e704113c1bb44e4ee388d7d3"
        ),
    ]
)
