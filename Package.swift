...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.15.214/foxKit-4.0.15.214.zip",
            checksum: "042913a5927c83d1bf6a3162d7fb9ef071100022e78b5f25806711bc4762d043"
        ),
    ]
)
