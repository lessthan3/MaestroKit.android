...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.6.122/foxKit-4.0.6.122.zip",
            checksum: "192963645a64d54d3a28a4d5fbbcfd68cb094c84d933cd2220b8a3245a706052"
        ),
    ]
)
