...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "paramountKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/paramountKit-4.0.27.292/paramountKit-4.0.27.292.zip",
            checksum: "14c21f4690b0f5c15adb1243845081c32e80621f6670c981d031432549caf353"
        ),
    ]
)
