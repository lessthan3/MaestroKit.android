...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.15.204/foxKit-4.0.15.204.zip",
            checksum: "a15842f4d8f9de6e547a0319687063857cb531ca029587a65f817cd859d07e49"
        ),
    ]
)
