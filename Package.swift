...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.14.200/foxKit-4.0.14.200.zip",
            checksum: "a89b9c2f26c2c2ac6417754cf35cd02dc5361a37decfcc4a867df803b0e7a1b8"
        ),
    ]
)
