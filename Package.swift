...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "paramountKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/paramountKit-4.0.26.278/paramountKit-4.0.26.278.zip",
            checksum: "d8c79528963150a0572a306f27ab58268dc5993a19325805747f75903c23fe03"
        ),
    ]
)
