...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.23.251/foxKit-4.0.23.251.zip",
            checksum: "6eca9ca433ddeba59f2bc2b817b03a3771cb1a44dfd6ede35b5313e7ec57d35f"
        ),
    ]
)
