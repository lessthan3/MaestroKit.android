...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.11.169/foxKit-4.0.11.169.zip",
            checksum: "51ce2113779039e69e0d5027710c8a2e71704dcefa2af04555d964fd000a0be1"
        ),
    ]
)
