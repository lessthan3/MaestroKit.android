...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.4.115/foxKit-4.0.4.115.zip",
            checksum: "18731a7667444ca91cdb9293f36dca980bd3c388b62be99b5f11934d59500213"
        ),
    ]
)
