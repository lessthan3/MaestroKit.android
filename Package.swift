...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.13.182/foxKit-4.0.13.182.zip",
            checksum: "160aa4a3e34c86ac156a1f312b35e8feeab295273642121f933ff8d550488d71"
        ),
    ]
)
