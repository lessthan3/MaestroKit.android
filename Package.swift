...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.4.120/foxKit-4.0.4.120.zip",
            checksum: "6ad46d343f8f808759b2fe4ad36d4822469a2e87f7e9667d1b8d32a242c8c035"
        ),
    ]
)
