...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.6.126/foxKit-4.0.6.126.zip",
            checksum: "db9f9112b9f220f12898493210d47e1fbf74cac32b43fe305e78fac576749523"
        ),
    ]
)
