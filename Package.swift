...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "paramountKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/paramountKit-4.0.34.327/paramountKit-4.0.34.327.zip",
            checksum: "4ed180e82a47592a0a5125d00d3abaf649cec2332f802895556e9b0a0f375b1a"
        ),
    ]
)
