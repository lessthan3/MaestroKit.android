...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "paramountKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/paramountKit-4.0.34.330/paramountKit-4.0.34.330.zip",
            checksum: "7dfd201324114175c1eb6203f7e995c5681e9a6c1f062f29be015dd00b826401"
        ),
    ]
)
