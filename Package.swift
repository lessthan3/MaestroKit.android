...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "paramountKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/paramountKit-4.0.26.280/paramountKit-4.0.26.280.zip",
            checksum: "3b7e444c6a6e60c0628caea8988d9f0adb4fc65256e54f1e0c78ab446d37d520"
        ),
    ]
)
