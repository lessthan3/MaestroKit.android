...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.19.230/foxKit-4.0.19.230.zip",
            checksum: "19d2fd55eaad19000ebf3521b6ae356bc9e92a87c3e526afb93581e10842f1de"
        ),
    ]
)
