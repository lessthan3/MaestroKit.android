...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/4.0.2.110/foxKit-4.0.2.110.zip",
            checksum: "22ccaa26e82abe10d747b11ebe39275d16bb27f8caec3e7a211e38a25fb9855c"
        ),
    ]
)
