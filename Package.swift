...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.8.142/foxKit-4.0.8.142.zip",
            checksum: "782d6c2624ce4e713b125d5d08f959dd1467bcc17f1392402b913cef9ec74ff6"
        ),
    ]
)
