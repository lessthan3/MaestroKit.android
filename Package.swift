...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.21.249/foxKit-4.0.21.249.zip",
            checksum: "14d1b473e2e0ffc244cee9680e0b50dc20623ae304e7b7a3742f14f36730079e"
        ),
    ]
)
