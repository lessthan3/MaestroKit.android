...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.12.175/foxKit-4.0.12.175.zip",
            checksum: "4b1ef7704e8e16a8f7bb5acf055a242b09df722b42880c458e9041ffd85b37b7"
        ),
    ]
)
