...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "paramountKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/paramountKit-4.0.28.293/paramountKit-4.0.28.293.zip",
            checksum: "eff521e473c19f2b05875cebcb0599bd855c60022f79d5597a423eb87aa8c0a6"
        ),
    ]
)
