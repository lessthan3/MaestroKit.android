...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.10.159/foxKit-4.0.10.159.zip",
            checksum: "a6bc0d6346e85e4f72d290e78d2c22ecf044ed4c493b12fed1e1974d8341363a"
        ),
    ]
)
