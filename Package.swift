...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.10.160/foxKit-4.0.10.160.zip",
            checksum: "c53388b80f6a4a5e3e3b96747ba292e09c04e443adc0609f2b6e3997135ae052"
        ),
    ]
)
