...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/4.0.3.112/foxKit-4.0.3.112.zip",
            checksum: "2b69f7b35f8eeb2b74e73adc9536c785bceed39cbbb6e7289f0bdf21c6ad4cc3"
        ),
    ]
)
