...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.11.166/foxKit-4.0.11.166.zip",
            checksum: "e89bfd308ec5387be47d8468cbf6e084032452598ba358f1c3032d668e673363"
        ),
    ]
)
