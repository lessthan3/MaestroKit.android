...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.18.220/foxKit-4.0.18.220.zip",
            checksum: "a167d5962f9a4778ab17a32042f5359b32f78a5ba8109c5efa220206b1b332d0"
        ),
    ]
)
