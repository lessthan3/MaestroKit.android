...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.11.162/foxKit-4.0.11.162.zip",
            checksum: "bb7664b12c56863e44c4956bb09ff027cd918937169a57a2256481c75a4f60f7"
        ),
    ]
)
