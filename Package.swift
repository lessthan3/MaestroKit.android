...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.13.178/foxKit-4.0.13.178.zip",
            checksum: "6725e2a300cd4abee94a2e10abffca8e4df16b53196781c2351da97e503763cf"
        ),
    ]
)
