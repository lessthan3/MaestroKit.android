...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.15.201/foxKit-4.0.15.201.zip",
            checksum: "e9120f49e200ba5a2b9c998790d22ec230925d518d849fb9d62af6c7dff58ca2"
        ),
    ]
)
