...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.8.138/foxKit-4.0.8.138.zip",
            checksum: "11eeeace330983914d02f08b19202b5f25bf1b029a8d109b04b998a4897af3ab"
        ),
    ]
)
