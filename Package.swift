...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.35.345/foxKit-4.0.35.345.zip",
            checksum: "ae2b3fb918775d6bdbad508a9721faba4381659b5ba41736818736e69c73caa9"
        ),
        .binaryTarget(
            name: "paramountKit",
