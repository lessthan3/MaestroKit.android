...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.18.223/foxKit-4.0.18.223.zip",
            checksum: "adf17110030d0ba0823b134ed9d3358bf29ec3f0181d3ca0810fb3ee19534893"
        ),
    ]
)
