...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.18.224/foxKit-4.0.18.224.zip",
            checksum: "5f8753a0cb64abd113259ba6ebc7736c047b9a7bbe803c4ec4f829e392662983"
        ),
    ]
)
