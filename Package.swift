...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/4.0.4.113/foxKit-4.0.4.113.zip",
            checksum: "2a9157c9411b53956e7e630022b70b716bd519743bfd798bb4bd7b646bf99729"
        ),
    ]
)
