...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.20.234/foxKit-4.0.20.234.zip",
            checksum: "d5b820a66b6f18dff779882c68c2e9cee016942ff169dda861c3a1c8e1be10e0"
        ),
    ]
)
