...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.14.189/foxKit-4.0.14.189.zip",
            checksum: "edba6d02b3b40c17ba64380c664046d1baf995215da6f09a6dda31a99918e413"
        ),
    ]
)
