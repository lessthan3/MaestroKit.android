...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.6.125/foxKit-4.0.6.125.zip",
            checksum: "a5d99f8eda611d28e2460df4e51b2761d6da2685818644f6ff8b59ae5f66ce67"
        ),
    ]
)
