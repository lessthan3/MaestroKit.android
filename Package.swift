...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.4.119/foxKit-4.0.4.119.zip",
            checksum: "6ded4114cde18e66c87c10acfe92d797c28191edc0fb10d824be48065952de32"
        ),
    ]
)
