...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.18.226/foxKit-4.0.18.226.zip",
            checksum: "771265202dac65f306fc923ccd8b1dc4f902119ea37cb52771bdb2fc83c1011d"
        ),
    ]
)
