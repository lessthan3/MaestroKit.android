...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.19.228/foxKit-4.0.19.228.zip",
            checksum: "0c3927bd7d1db1b029e46f1b5b53be76eef4bb66d7945e04612ea8b7630d7baf"
        ),
    ]
)
