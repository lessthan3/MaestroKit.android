...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.14.198/foxKit-4.0.14.198.zip",
            checksum: "1bb323dfcfe2989cc924c5612fad5acac6ce19627a4e7dc3fa41f91c81edd05a"
        ),
    ]
)
