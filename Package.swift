...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.21.250/foxKit-4.0.21.250.zip",
            checksum: "64d04612e64b9e35f504f35d0a83ac306ee8bfb2b58ab6b21af51a4c9ebcdf00"
        ),
    ]
)
