...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.6.124/foxKit-4.0.6.124.zip",
            checksum: "2420bb34eb2dcb7aff33ed9ebba4c095ea65214b6a43cbcb3259142491220b1d"
        ),
    ]
)
