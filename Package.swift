...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.14.188/foxKit-4.0.14.188.zip",
            checksum: "6f3db4c1031310ef9ccca15cd932649b5ab2c79a32b489563b606b15b72050f6"
        ),
    ]
)
