...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.6.127/foxKit-4.0.6.127.zip",
            checksum: "4167072e2fd281731ee94241eff781cb5406a04d1a6fe7e42cb2560d0b60a71f"
        ),
    ]
)
