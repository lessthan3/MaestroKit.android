...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.20.235/foxKit-4.0.20.235.zip",
            checksum: "6e7da7ed2449ee1c19ef2f5dbbc9ef47c92ba485d0a148662e3eb7384dad6817"
        ),
    ]
)
