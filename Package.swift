...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "paramountKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/paramountKit-4.0.36.366/paramountKit-4.0.36.366.zip",
            checksum: "44f828405e523cfdb696b99f1da7002858e534aa10ebe31f6f32bbbc18d71c60"
        ),
    ]
)
