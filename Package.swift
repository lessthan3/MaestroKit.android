...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.20.237/foxKit-4.0.20.237.zip",
            checksum: "086ffe1c63a03cc70d9c2e156ac2922ff0b4c66fb1300dc53a62cd7871fa8634"
        ),
    ]
)
