...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.12.174/foxKit-4.0.12.174.zip",
            checksum: "17bbb5545850fe88fb1e81c5016b4f5771104ece844517d35b0a46f2064ff912"
        ),
    ]
)
