...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.8.139/foxKit-4.0.8.139.zip",
            checksum: "e2e4c2b53728be4b1dc0fffe7a78e24a30e62d560354fbae54abe3d2e1ad3266"
        ),
    ]
)
