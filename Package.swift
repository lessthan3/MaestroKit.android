...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.6.129/foxKit-4.0.6.129.zip",
            checksum: "06b0a175b18b75a78917e046db5954e96509026ba201ea0553d27c54294f01de"
        ),
    ]
)
