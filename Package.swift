...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.17.217/foxKit-4.0.17.217.zip",
            checksum: "b6703210997cdb23f6d5286f38d645624f8750e690e1114cd70f544adec8d3d6"
        ),
    ]
)
