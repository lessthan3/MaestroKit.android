...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.25.273/foxKit-4.0.25.273.zip",
            checksum: "38b2a08a7bcd24e5769d274c85a93198d945a648ae27ebd375497e4c92de2fcd"
        ),
        .binaryTarget(
            name: "paramountKit",
