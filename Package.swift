...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.20.240/foxKit-4.0.20.240.zip",
            checksum: "3a216ee1749e46c20afd0f70b029942bf92161da09d3aac1dc5a9052839c472c"
        ),
    ]
)
