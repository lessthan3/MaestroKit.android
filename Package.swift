...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "paramountKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/paramountKit-4.0.31.309/paramountKit-4.0.31.309.zip",
            checksum: "a0ec9482d0794f3cd1caa80b401ed18e8383c39a286ed886dda5ef7920bc4ac4"
        ),
    ]
)
