...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.20.232/foxKit-4.0.20.232.zip",
            checksum: "9c6e78985281384425bd0ff90c03d2ae11547d45378d55f5a99401bd0747aeb5"
        ),
    ]
)
