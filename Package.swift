...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.21.245/foxKit-4.0.21.245.zip",
            checksum: "7e2a86e73bec38b00ac1da32491884213a5a3116434979de497c433006b87265"
        ),
    ]
)
