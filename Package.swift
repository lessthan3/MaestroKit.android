...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/4.0.0-SNAPSHOT.90/foxKit-4.0.0-SNAPSHOT.90.zip",
            checksum: "c9d1b257bf35fc3ea4873c89c9948699f5da54fdd2b90fa3e1fc0498372fea4f"
        ),
    ]
)
