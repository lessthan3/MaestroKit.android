...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.19.229/foxKit-4.0.19.229.zip",
            checksum: "57501a10ff785bcd9c7cbc7a542b94f6708a54be9c5ef38c4723e3bd2b81ad9b"
        ),
    ]
)
