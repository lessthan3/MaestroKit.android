...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.15.205/foxKit-4.0.15.205.zip",
            checksum: "e569c732bf2b3ea59ae653c5bc5a524e2c6603f486f21619af80572822cfb824"
        ),
    ]
)
