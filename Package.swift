...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.8.136/foxKit-4.0.8.136.zip",
            checksum: "a939a619d508376b26231bd29445f5e19ce8019ffc1984c499e5801f3183fae0"
        ),
    ]
)
