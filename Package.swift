...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.13.183/foxKit-4.0.13.183.zip",
            checksum: "37496282ba412c1032ba40c740ad0a007036c5a05cc4b922a991fa6623dd420f"
        ),
    ]
)
