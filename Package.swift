...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.14.190/foxKit-4.0.14.190.zip",
            checksum: "364ad4dcb41f0d6fae924962433cede361ebb6ba88825d46eedf620f3c697af1"
        ),
    ]
)
