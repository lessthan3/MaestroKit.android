...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.18.227/foxKit-4.0.18.227.zip",
            checksum: "14a951cd6814f14cfd9b0565c79c3e4933ae83a4ac85604db78acec5937a5901"
        ),
    ]
)
