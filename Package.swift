...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "paramountKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/paramountKit-4.0.37.377/paramountKit-4.0.37.377.zip",
            checksum: "97e73cc487953e195ff016bf5506f795f24226d3ed8c1b0d01e245cc2e3146be"
        ),
    ]
)
