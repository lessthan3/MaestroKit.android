...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.6.128/foxKit-4.0.6.128.zip",
            checksum: "2099719b724cc5b98037f2cd5a5ab0ccb3f8a447b9b8dfe8a56f49f1e0cdf702"
        ),
    ]
)
