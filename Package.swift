...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.33.323/foxKit-4.0.33.323.zip",
            checksum: "7bd2ab04baba769735e5e1cfef892bb60c0240cbc882c654377f66047adaa071"
        ),
        .binaryTarget(
            name: "paramountKit",
