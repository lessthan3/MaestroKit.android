...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.20.233/foxKit-4.0.20.233.zip",
            checksum: "b74f578690624d77bfab13f6beedb868e2dde96a7b8f40ea415950e31e6ff484"
        ),
    ]
)
