...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.14.187/foxKit-4.0.14.187.zip",
            checksum: "111e468334a8430f66a6414f4b8c3a551e7612860b8c64030ed77b2fe37571b4"
        ),
    ]
)
