...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.20.236/foxKit-4.0.20.236.zip",
            checksum: "1cbf27f5af4e7d5693ccc4d8e7766391dbf2d6dffc28ea1cad65834d1e4cc01c"
        ),
    ]
)
