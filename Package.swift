...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.18.225/foxKit-4.0.18.225.zip",
            checksum: "822bfaa2f3657e01d141857cda7aef9d31211f5c1bf33232b514da56354f5472"
        ),
    ]
)
