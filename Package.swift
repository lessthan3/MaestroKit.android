...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.26.281/foxKit-4.0.26.281.zip",
            checksum: "e50899dcd624243d5a1352460506277d629076210ea42dfa560438b253ae0b2d"
        ),
        .binaryTarget(
            name: "paramountKit",
