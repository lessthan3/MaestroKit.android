...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.12.177/foxKit-4.0.12.177.zip",
            checksum: "b0ec11b5e7bc4a9cafb5fb2145d21171ed9a3685ce6bdc46b459e776edecdc76"
        ),
    ]
)
