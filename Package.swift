...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/4.0.3.111/foxKit-4.0.3.111.zip",
            checksum: "20d16f9246c2abf0dc8074200a97500eb871e2bc5ae6be5b2db86562273f47e8"
        ),
    ]
)
