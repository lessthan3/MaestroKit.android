...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "foxKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/foxKit-4.0.24.259/foxKit-4.0.24.259.zip",
            checksum: "5cfd19566125f259bf9c090d39af789ed343d1e29eec11ef90dc0a60535ef828"
        ),
    ]
)
