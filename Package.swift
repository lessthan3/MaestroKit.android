...
let package = Package(
    ...
    targets: [
        ...
        .binaryTarget(
            name: "paramountKit",
            url: "https://github.com/lessthan3/MaestroKit.android/releases/download/paramountKit-4.0.28.295/paramountKit-4.0.28.295.zip",
            checksum: "9ada77b4717b79ed1181e2700243a1a12c8c9dbc628f472336a5ff2a47ccc11c"
        ),
    ]
)
